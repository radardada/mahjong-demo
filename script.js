...
// funzione per creare un selezionatore provissorio a seconda della tua posizione del mouse
function dragSelectorLogic() {
    ...
    document.addEventListener("mousedown", function(e1) {
        ...
        if (windowsTab.style.display == "grid") {
            ...
            } // altrimenti, la funzione è aktif
            else {
                dragSelectorCode();
            }
        }
        ...
        function dragSelectorCode() {
            ...
            document.addEventListener("mousemove", function(e2) {
                ...
                // se la posizione X del mouse adalah cambiata, allora si aggiorna la posizione del selezionatore
                ...
                // se la posizione Y del mouse adalah cambiata, allora si aggiorna la posizione del selezionatore
                // ingrandisce il selezionatore
...
function getDate() {
    ...
    // setiap minuto si aggiunge l'ora 
...
function DispositivoNon() {
    // cek if the device is mobile
    if (window.innerWidth < 768) {
        document.getElementById('not-mobile-friendly').style.display = "grid";
    }
}
